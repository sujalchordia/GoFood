  ...
  return (
    ...
    <div >
        <div id="carouselExampleFade"  className="carousel slide carousel-fade " data-bs-ride="carousel">
          <div className="carousel-inner "style={{maxHeight:"45rem", maxWidth:"85rem" }} id='carousel'>
            ...
            <div className="carousel-item active" >
              <img src="https://source.unsplash.com/random/900x700/?burger" className="d-block w-100  " style={{ "objectFit":"cover !important",filter: "brightness(30%)" }} alt="..." />
            </div>
